//
//  GrowingAdvertisingiOS13UITests.m
//  GrowingAdvertising
//
...
@interface GrowingAdvertisingiOS13UITests : XCTestCase

@end

@implementation GrowingAdvertisingiOS13UITests
...
- (void)test01DeeplinkFromSafari_fromBackgroundedApp {
    // 长链-urlscheme无参数
    NSString *url = @"growing.54e804b6de39cd4a://growing?link_id=dMbpE&click_id=85b9310f-d903-4b02-ae7d-3b696e730937"
...
- (void)test13WebCircleFromSafari_thatLaunchesTheApp {
    ...
    NSString *url = @"growing.54e804b6de39cd4a://growingio/webservice?serviceType=circle"
